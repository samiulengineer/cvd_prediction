...
for epoch in range(Epoch):
    ...
    print('loss: '+str(loss_train) + ' acc: ' + str(accuracy*100))
    print('roc auc: '+str(roc*100))
    print(error)
print('best epoch: '+str(best_epoch)+' || best_acc: '+str(best_acc*100)+' || best_auc: '+str(best_auc*100))
print(best_weight)
